...
import { DeleteModal } from '@/features/insights/components/DeleteModal';
import { RenameModal } from '@/features/insights/components/RenameModal';
        ...
        <Pressable style={styles.backdrop} onPress={closeMenu}>
          ...
          >
            ...
            <Pressable style={styles.menuItem} onPress={handleDelete}>
              <Typography variant="body1" color="#EF4444">Delete</Typography>
              <DeleteIcon size={18} />
            </Pressable>
          </Pressable>
        </Pressable>
